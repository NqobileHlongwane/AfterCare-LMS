...
<body>
    ...
    <div class="container">
        ...
        <ul class="dashboard-list">
            <li onclick="location.href='groups.php'"><a href="groups.php">Group Management</a></li>
            <li onclick="location.href='assignments.php'"><a href="assignments.php">Task Creation</a></li>
            <li onclick="location.href='submissions.php'"><a href="submissions.php">Submission Review</a></li>
            <li onclick="location.href='meetings.php'"><a href="meetings.php">Meeting Link Uploader</a></li>
            <li onclick="location.href='announcements.php'"><a href="announcements.php">Announcements</a></li>
            <li onclick="location.href='grade.php'"><a href="grade.php">Grade Submissions</a></li>
            <li onclick="location.href='assign_learners.php'"><a href="assign_learners.php">Assign Learners to Groups</a></li>
        </ul>
